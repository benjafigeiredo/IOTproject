...
export declare function buildTableOutput(tableGenerator: TableGenerator, data: DeviceProfileTranslations): string;
export declare type DeviceProfileWithLocales = DeviceProfile & {
    locales?: string;
};
