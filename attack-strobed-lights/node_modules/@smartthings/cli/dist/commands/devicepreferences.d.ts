...
export declare const tableFieldDefinitions: TableFieldDefinition<DevicePreference>[];
export declare function chooseDevicePreference(command: APICommand, preferenceFromArg?: string): Promise<string>;
