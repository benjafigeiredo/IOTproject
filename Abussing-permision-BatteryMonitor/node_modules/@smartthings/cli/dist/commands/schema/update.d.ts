...
export default class SchemaUpdateCommand extends APICommand {
    ...
    static flags: {
        principal: flags.IOptionFlag<string | undefined>;
        'statement-id': flags.IOptionFlag<string | undefined>;
        authorize: import("@oclif/parser/lib/flags").IBooleanFlag<boolean>;
