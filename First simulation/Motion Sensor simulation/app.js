...
// variable to control the refresh response of motionSensor
let RRtype = 0; 

// IMPLEMENTAR UN SISTEMA DE PAR/IMPAR PARA QUE SE LEA EL REFRESH RESPONSE UNA VEZ COMO ACTIVO Y OTRA COMO INACTIVO CADA VEZ Q REFRESCO
...
function stateRefreshRequest(requestId, devices) 
{
    ...
    if (RRtype % 2 == 0)
    {
        refreshResponse = require("./refreshResponseActive.json");
    }
    else
    {
        refreshResponse = require("./refreshResponseInactive.json");;
    }
    RRtype = RRtype + 1 ;
